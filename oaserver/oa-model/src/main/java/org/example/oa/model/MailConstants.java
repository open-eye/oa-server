...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "example.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "example.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "example.mail.routing.key";
}
